...
class exampleMyHomePage extends StatefulWidget {
  const exampleMyHomePage({Key? key}) : super(key: key);

  @override
  _exampleMyHomePageState createState() => _exampleMyHomePageState();
}

class _exampleMyHomePageState extends State<exampleMyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Inodesys Technologies"),
      ),
      body: Stack(
        children: [
          // Your map and other widgets here
          GoogleMap(
          ...
          // Add the ListView.builder for displaying alarms
  ...
  Widget buildAlarmContainer(AlarmDetails alarm) {
    return Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text('Alarm Name: ${alarm.alarmName}'),
              const SizedBox(height: 10),
              Text('Notes: ${alarm.notes}'),
              const SizedBox(height: 10),
              Text('Location Radius: ${alarm.locationRadius} meters'),
              const SizedBox(height: 10),
              Text('Is Alarm On: ${alarm.isAlarmOn ? 'On' : 'Off'}'),
  ...
  void _showCustomBottomSheet(BuildContext context) {
    TextEditingController alramcontroller=new TextEditingController();
...
setState(() {
alarms.add(AlarmDetails(
alarmName: alramcontroller.text,
notes: notescontroller.text,
locationRadius: radius,
isAlarmOn: true,
));
