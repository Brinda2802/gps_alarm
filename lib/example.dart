...
// // //     ],
// // //   );
// //   // Initialize AudioPlayer from audioplayers
// //
// //
// // // Initialize AudioPlayer from just_audio for advanced features
// //   late final AudioPlayer _advancedAudioPlayer = AudioPlayer();
// //
// // // Define the audio source using just_audio
// //   final audioSource = ConcatenatingAudioSource(
// //     // Set up lazy preparation and shuffle order
// //     useLazyPreparation: true,
// //     shuffleOrder: DefaultShuffleOrder(),
...
// //   Future<void> _playRingtone(String ringtone) async {
// //     // Ensure assets/alarm_ringtones/ is the correct path
// //     final ringtonePath = 'asset:///android/app/src/main/res/raw/$ringtone';
// //     try {
// //       await _audioPlayer.setAudioSource(AudioSource.uri(Uri.parse(ringtonePath)));
...
// //                 },
// //                 child: Icon(
// //                   CupertinoIcons.play_arrow_solid,size: 30,),
// //               ),
// //               GestureDetector(
// //                 onTap: (){
// //                   _audioPlayer.stop();
// //                 },
// //                 child: Icon(
// //                   CupertinoIcons.stop_fill,size: 30,),
// //               ),
// //
// //             ],
// //           ),
...
//   State<Settings> createState() => _SettingsState();
// }
// enum AlarmOption { alarms, vibrate, both }
// class _SettingsState extends State<Settings> {
//   late  final AudioPlayer _audioPlayer = AudioPlayer();
//   AlarmOption? _selectedOption;
//
//   bool _isMetricSystem = true;
//   double radius=0;
//   double meterRadius = 0.1; // Initial value for meter radius
...
//             // Save selected ringtone
//           });
//           await _saveSettings(value, _selectedOption);
//           // _saveSelectedRingtone(value);
//           _playRingtone(selectedRingtone!);
//           // await flutterLocalNotificationsPlugin
//           //     .resolvePlatformSpecificImplementation<
...
//   //   print('Selected ringtone loaded: $selectedRingtone');
//   // }
//   Future<void> _saveSettings(String ringtone, AlarmOption? selectedOption) async {
//     final prefs = await SharedPreferences.getInstance();
//     await prefs.setString('selectedRingtone', ringtone);
//     await prefs.setString('selected_alarm_option', selectedOption.toString());
//     print('Saved settings: ringtone: $ringtone, selectedOption: $selectedOption');
//   }
//   Future<Map<String, dynamic>> _loadSettings() async {
//     final prefs = await SharedPreferences.getInstance();
//     final ringtone = prefs.getString('selectedRingtone') ?? "alarm6.mp3";
//     final selectedOptionString = prefs.getString('selected_alarm_option') ?? 'AlarmOption.alarms';
//     final selectedOption = AlarmOption.values.firstWhere(
//           (e) => e.toString() == selectedOptionString,
//       orElse: () => AlarmOption.alarms,
//     );
//
//     print('Loaded settings: ringtone: $ringtone, selectedOption: $selectedOption');
//
//     return {
//       'ringtone': ringtone,
...
//               //   }).toList(),
//               // ),
//               RadioListTile<AlarmOption>(
//                 title: const Text('Alarms'),
//                 value: AlarmOption.alarms,
//                 groupValue: _selectedOption,
//                 onChanged: (AlarmOption? value) {
//                   setState(() {
//                     _selectedOption = value;
//                     _saveSettings(selectedRingtone ?? '', _selectedOption);
//                   });
//                 },
//               ),
//               RadioListTile<AlarmOption>(
//                 title: const Text('Vibrate'),
//                 value: AlarmOption.vibrate,
//                 groupValue: _selectedOption,
//                 onChanged: (AlarmOption? value) {
//                   setState(() {
//                     _selectedOption = value;
...
//               ),
//               Divider(),
//               if (_selectedOption == AlarmOption.alarms || _selectedOption == AlarmOption.both)
//                 SizedBox(
//                   height:height/37.8,
//                 ),
//               Text("Alarms",style:Theme.of(context).textTheme.titleLarge, ),
//               if (_selectedOption == AlarmOption.alarms || _selectedOption == AlarmOption.both)
//
//                 _buildRingtoneDropdown(),
//               if (_selectedOption == AlarmOption.alarms || _selectedOption == AlarmOption.both)
...
//
//               // Visibility(
//               //   visible: isAlarmsSelected ||  isBothSelected,
//               //   child: Container(
//               //     child: Column(
//               //       crossAxisAlignment: CrossAxisAlignment.start,
//               //       children: [
...
//                 child: FilledButton(
//                   onPressed: () async {
//                     await _saveSettings(selectedRingtone ?? '', _selectedOption);
//                     _handleSettingsSet();
//                   },  child: Text("Set"),
//                   // Call the saveAlarm functio
//                 ),
