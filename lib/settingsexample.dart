...
class _SettingsState extends State<Settings> {
  ...
  bool _alarmsSelected = false;
  bool _vibrateSelected = false;
  bool _alarminsilentmode = false;
        ...
        underline: Container(
          ...
          color: Colors.transparent,
              ...
              CheckboxListTile(
                ...
                value: _alarminsilentmode,
                onChanged: (bool? value) {
                  setState(() {
                    _alarminsilentmode = value!;
                    print(value);
                    _savesettings(selectedRingtone!);
                  });
                },
